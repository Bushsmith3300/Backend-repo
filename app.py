...
["The rate of reaction is R = k[X]^2[Y]. By what factor will the rate of the reaction increase \
if the concentrations of X and Y are both doubled?\n\nA. 4 times\nB. 8 times\nC. 27 times\n\
D. 64 times", "B"],
...
R = K[A]^2 [B]^2 [C]. By how many times will the rate increase, if the concentrations \
of all reactants are doubled?\n\nA. 4\nB. 8\nC. 16\nD. 32", "D"],
["The reaction, 2NO(g) + O2(g) ----> 2NO2(g) was found to be first order with respect to \
each of the reactants. The rate law should therefore be written as \n\nA. Rate = K[NO] ^ 2[O2]\n\n \
B. Rate = K[NO][O2]\n\nC. Rate = K[NO2] ^ 2[O2] ^ 2\n\nD. Rate = K[NO][O2] ^ 2", "B"]]
